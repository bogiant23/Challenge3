...
function gameResult(ai, human) {
  ...
  if (human == "batu")
    return ai == "gunting" ? (result = "PLAYER 1 WIN") : (result = "COM WIN");
  if (human == "kertas")
    return ai == "batu" ? (result = "PLAYER 1 WIN") : (result = "COM WIN");
  if (human == "gunting")
    return ai == "kertas" ? (result = "PLAYER 1 WIN") : (result = "COM WIN");
}
